function setWorld(worldState) {
    ...
    player.onCollide('npc', () => {
        ...
        const dialogue = "Hi, I'm Mandira and I love discovering and preserving all species. Can you help me in my mission to save these animals? Be careful though, they do put up a fight!"
        ...
        if (worldState.faintedMons < 4) {
            ...
            content.text = "You've saved the animal, Well done!"
        }
