...
const Experience = () => {
  ...
  const ExperienceCard = ({ experience }) => (
    <VerticalTimelineElement contentStyle={{ background: '#1d1836', color: '#fff'}} contentArrowStyle={{ borderRight: '7px solid #232631'}} date={experience.date} iconStyle={{ background: experience.iconBg }} icon={
      <div className="flex justify-center items-center w-full h-full">
        <img src={experience.icon} alt={experience.company_name} className="w-200 h-200 object-contain" />
      </div>
    }>
      <div>
  ...
  return (
    <>
      ...
      <p className={styles.sectionSubText}>Our process for the project development</p>
